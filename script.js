...
function setActive(id) {
  var isProjectsPage = window.location.pathname.replace(/\/+$/, '') === '/projects' || window.location.pathname.includes('projects.html');
  var isCertPage = window.location.pathname.replace(/\/+$/, '') === '/certifications' || window.location.pathname.includes('certifications.html');
  
  navLinks.forEach(function(link) {
    var linkSection = link.getAttribute('data-section');
    
    // On the projects page, keep Projects active
    ...
    // On the certifications page, keep Education active
